 ...
 * href="http://svn.terracotta.org/svn/quartz/trunk/quartz-core/src/main/java/org/quartz/CronExpression.java">Quartz
 * project - http://svn.terracotta.org/svn/quartz/trunk/quartz-core/src/main/java/org/quartz/CronExpression.java</a>
 * <p>
 * 
 * 
 ...
 * numbers range from 0 to 59. For hours 0 to 23, for days of the month 0 to 31, and for months 0 to 11 (JAN to DEC).
 * The &quot;/&quot; character simply helps you turn on every &quot;nth&quot; value in the given set. Thus
 * &quot;7/6&quot; in the month field only turns on month &quot;7&quot;, it does NOT mean every 6th month, please note
 * that subtlety.
 * <P>
 ...
 * the month, such as "L-3" which would mean the third-to-last day of the calendar month. <i>When using the 'L' option,
 * it is important not to specify lists, or ranges of values, as you'll get confusing/unexpected results.</i>
 * <P>
 ...
 * <li>Overflowing ranges is supported - that is, having a larger number on the left hand side than the right. You might
 ...
 * determine which interpretation CronExpression chooses. An example would be "0 0 14-6 ? * FRI-MON".</li>
 * </ul>
 * </p>
 * 
 * 
...
public final class CronExpression implements Serializable, Cloneable {
	...
	public CronExpression(CronExpression expression) {
		/*
		 * We don't call the other constructor here since we need to swallow the ParseException. We also elide some of the
		 * sanity checking as it is not logically trippable.
		 */
	...
	public Date getNextInvalidTimeAfter(Date date) {
		...
		// FUTURE_TODO: (QUARTZ-481) IMPROVE THIS! The following is a BAD solution to this problem. Performance will be very
