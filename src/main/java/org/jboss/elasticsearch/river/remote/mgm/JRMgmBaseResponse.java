...
/**
 * Base for action responses from to the Remote River. All node responses are aggregated here.
 * 
...
public abstract class JRMgmBaseResponse<T extends NodeJRMgmBaseResponse> extends NodesOperationResponse<T> {
	...
	/**
	 * Get response from node where running Remote river instance was found.
	 * 
