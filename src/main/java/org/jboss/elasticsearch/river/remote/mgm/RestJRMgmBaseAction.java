...
/**
 * Base for REST action handlers for RemoteRiver management operations.
 * 
...
public abstract class RestJRMgmBaseAction extends BaseRestHandler {
	...
	/**
	 * Prepare base REST URL for Remote river management operations. <code>riverName</code> request parameter is defined
	 * here.
	 * 
