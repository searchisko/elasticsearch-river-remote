...
import org.jboss.elasticsearch.river.remote.mgm.lifecycle.NodeJRLifecycleRequest;
...
import org.jboss.elasticsearch.river.remote.mgm.lifecycle.TransportJRLifecycleActionTest;
...
public class TransportJRMgmBaseActionTest {
	...
	public void constructor() {
		...
		Assert.assertEquals(
				"org.elasticsearch.org.jboss.elasticsearch.river.remote.mgm.lifecycle.TransportJRLifecycleAction",
	...
	public void nodeOperation() {
		...
		String myRiverName = "myRiver";

		IRiverMgm jiraRiverMock = Mockito.mock(IRiverMgm.class);
		RiverName riverName = new RiverName("jira", myRiverName);
		...
		try {
			...
			RemoteRiver.removeRunningInstances(myRiverName);
		}
