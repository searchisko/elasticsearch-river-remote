...
public class NodeFullUpdateResponse extends NodeJRMgmBaseResponse {
	 ...
	 * @param reindexedSpaces CSV names of Spaces which was forced for full reindex
	 */
	public NodeFullUpdateResponse(DiscoveryNode node, boolean riverFound, boolean spaceFound, String reindexedSpaces) {
